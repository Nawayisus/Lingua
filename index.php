            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div id="progressArea" class="mt-4 d-none">
                        ...
                        <div class="progress">
                            <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-label="Progreso de la traducción" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%" id="progressBar"></div>
                        </div>
